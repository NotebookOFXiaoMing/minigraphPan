...
datcore<-read_delim(paste0("remap/", args[1],"_coverage.tsv"))
...
#datlen <- read.table(paste0("graph/",args[1],"_graph_length.tsv"),
#                     header=FALSE,stringsAsFactors = FALSE)
datlen <- read_delim(paste0("graph/",args[1],"_graph_length.tsv"),col_names=FALSE)
